...
function AddProduct() {
  ...
  return (
    <div className="m-0 p-0">
      <navbar className="top-0 left-0 w-full bg-gray-800 text-white py-4 px-5 flex justify-between items-center border-b-2">
        Hello
      </navbar>
      <div>
        <h1 className="text-black text-6xl mt-7 ml-4 mb-4 font-extrabold">
          Sell a Product
        </h1>
        <hr className="border-t-4 h-8"></hr>
      </div>

      <div className="flex float-right flex-col justify-center w-96 h-80 mr-16">
        <div className="align-top w-full border border-black h-64 border-dashed">
          {images.map((image, index) => (
            <div key={index}>
              <img id="preview" src={image} alt={`Preview ${index + 1}`} />
            </div>
          ))}
        </div>
      ...
      <div>
        <form className="" onSubmit={handleSubmit} autoComplete="off">
          <div className="grid grid-cols-2 gap-4 auto-rows-min">
            <div className="">
              <h1 className="italic ml-4 mb-2">Product Name :</h1>
              <input
            ...
            <div className="">
              <h1 className="italic ml-4 mb-2">Product Description :</h1>
            ...
            <div className="">
              <h1 className="italic ml-4 mb-2">Quantity</h1>
            ...
            <div>
              <h1 className="italic ml-4 mb-2">Condition :</h1>
            ...
            <div>
              <h1 className="italic ml-4 mb-2">Damage Description :</h1>
            ...
            <div>
              <h1 className="italic ml-4 mb-2">Starting Bid :</h1>
              <input
                type="number"
            ...
            <div>
              <h1 className="italic ml-4 mb-2">Minimum Raise Amount :</h1>
          ...
          <div className="flex items-center justify-center">
            <button
              type="submit"
              className=" px-4 py-2 border-2 w-72 ml-4 mb-10 mt-10 font-bold bg-[rgba(62,156,53,255)] text-white rounded-md hover:bg-green-600 shadow-[9px_8px_15px_rgba(0,0,0,0.3)] active:scale-90 transition-transform"
            >
              Add Product
            </button>
          </div>
